...
def export():
    ...
    db_dir = 'wxid_g4pshorcc0r529/db_storage'  # 解析后的数据库路径，例如：./db_storage
    db_version = 4  # 数据库版本，4 or 3

    wxid = 'wxid_k19cxgha5o9q32'  # 要导出好友的wxid
    output_dir = './export_data/'  # 输出文件夹
    ...
    exporter = TxtExporter(
        ...
        time_range=['2025-09-12 00:00:00', '2025-12-12 00:00:00'],  # 要导出的日期范围，默认全导出
